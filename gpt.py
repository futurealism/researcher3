...
OPENAI_TEMP = float(os.getenv("OPENAI_TEMP"))
OPENAI_FUNCTION_MODEL = os.getenv("OPENAI_FUNCTION_MODEL")
OPENAI_FUNCTION_TEMP = float(os.getenv("OPENAI_FUNCTION_TEMP"))
OPENAI_POLLING_SPEED = float(os.getenv("OPENAI_POLLING_SPEED"))
OPENAI_GA_MODEL = os.getenv("OPENAI_GA_MODEL")
